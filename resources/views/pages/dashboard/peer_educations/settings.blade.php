<x-layouts.dashboard title="Pengaturan Banner Edukasi Sebaya | Admin PIK-R">
    <div>
        <header class="h-20 bg-white border-b border-slate-100 flex items-center justify-between px-6 lg:px-10 sticky top-0 z-40">
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-[10px] font-bold text-slate-400 uppercase tracking-widest mt-1">Sesuaikan tampilan awal Edukasi Sebaya</p>
                </div>
            </div>
        </header>
        ...
        <div class="p-6 lg:p-10 max-w-4xl mx-auto w-full">
            ...
            <div class="bg-white rounded-3xl border border-slate-100 shadow-sm overflow-hidden">
                <form action="{{ route('dashboard.peer-educations.settings.update') }}" method="POST" enctype="multipart/form-data" class="p-8">
                    @csrf
                        ...
                        <div class="space-y-6">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input type="text" name="hero_title_1" id="hero_title_1" value="{{ old('hero_title_1', $settings['hero_title_1'] ?? 'Edukasi Sebaya') }}" class="w-full px-4 py-3 rounded-xl bg-slate-50 border-transparent focus:border-[#1e3a8a] focus:bg-white focus:ring-0 text-sm font-medium transition-all" required>
                                    <p class="text-[10px] font-bold text-slate-400 mt-2">Teks normal (putih). Contoh: "Edukasi Sebaya"</p>
                                    @error('hero_title_1')
