<x-layouts.app title="Registrasi | PIK-R REQUEST">
    <div class="min-h-screen relative flex items-center justify-center bg-[#f8fafc] text-slate-800 font-sans overflow-hidden py-12 px-4 sm:px-6 lg:px-8" x-data="{ showPassword: false, showConfirmPassword: false }">
        ...
        <div class="relative z-10 w-full max-w-4xl mx-auto bg-white rounded-[2.5rem] border border-slate-200/80 shadow-[0_20px_50px_rgba(30,64,175,0.08)] overflow-hidden grid grid-cols-1 lg:grid-cols-12" data-aos="fade-up" data-aos-duration="800">
            ...
            <div class="hidden lg:flex lg:col-span-5 bg-gradient-to-br from-[#1b3c66] via-[#1e40af] to-[#2563eb] text-white p-10 flex-col justify-between relative overflow-hidden">
                ...
                <div class="relative z-10">
                    ...
                    <div class="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-white/15 border border-white/20 text-white text-xs font-semibold backdrop-blur-md mb-8">
                        <i class="fas fa-user-plus text-amber-300"></i>
                    ...
                    <p class="text-blue-100 text-xs leading-relaxed mb-8">
                        Jadilah bagian dari generasi berencana PIK-R REQUEST SMAN 1 Tasik Putri Puyu untuk mengembangkan potensi dan wawasan.
                    </p>
                    ...
                    <div class="space-y-4">
                        <div class="flex items-center gap-3">
                            ...
                            <span class="text-xs font-medium text-blue-50">Pengembangan Softskill & Leadership</span>
                        </div>
                        <div class="flex items-center gap-3">
                            <div class="w-8 h-8 rounded-xl bg-white/10 flex items-center justify-center text-white text-xs shrink-0">
                                <i class="fas fa-check"></i>
                            </div>
                            <span class="text-xs font-medium text-blue-50">Komunitas Remaja Positif</span>
                        </div>
                        <div class="flex items-center gap-3">
                            <div class="w-8 h-8 rounded-xl bg-white/10 flex items-center justify-center text-white text-xs shrink-0">
                                <i class="fas fa-check"></i>
                            </div>
                            <span class="text-xs font-medium text-blue-50">Aktivitas & Event Seru</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="relative z-10 pt-8 border-t border-white/15">
                    <p class="text-xs text-blue-100 italic" style="font-family: 'Dancing Script', cursive; font-size: 1.15rem;">
                        "Tuntut Ilmu, Asah Kemampuan, Tebar Manfaat."
                    </p>
                </div>
            </div>
            ...
            <div class="col-span-1 lg:col-span-7 p-8 sm:p-12 flex flex-col justify-center bg-white">
                ...
                <div class="flex flex-col items-center text-center mb-6">
                    ...
                    <h2 class="text-2xl font-bold text-[#1b3c66] tracking-tight">Buat Akun Baru ✨</h2>
                    <p class="text-slate-400 text-xs font-medium mt-1">Lengkapi data di bawah ini</p>
                </div>

                <!-- Validation Errors -->
                @if ($errors->any())
                    <div class="bg-rose-50 border border-rose-200 text-rose-700 p-3.5 rounded-2xl text-xs font-medium mb-6">
                ...
                <!-- Register Form -->
                <form action="{{ route('register.post') }}" method="POST" class="space-y-4" onsubmit="handleRegisterSubmit(event)">
                    @csrf
                    ...
                    <div class="space-y-1">
                        <label class="block text-xs font-bold text-slate-700 ml-1">Konfirmasi Password</label>
                        <div class="relative">
                            <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-slate-400">
                    ...
                    <!-- Submit Button -->
                    <button type="submit" id="btnRegisterSubmit" class="w-full bg-[#1e40af] hover:bg-blue-800 text-white font-bold text-sm py-3.5 rounded-2xl shadow-lg shadow-blue-900/10 hover:shadow-blue-900/20 active:scale-[0.99] transition-all duration-200 flex items-center justify-center gap-2 group mt-4">
                ...
                <div class="relative my-5">
                    ...
                    <div class="relative flex justify-center text-xs">
                        <span class="bg-white px-3 text-slate-400 font-medium">Sudah memiliki akun?</span>
                    </div>
                </div>

                <!-- Login Action -->
                <a href="{{ route('login') }}" class="inline-flex items-center justify-center w-full py-3 px-4 rounded-2xl border border-blue-100 bg-blue-50/60 hover:bg-blue-50 text-blue-700 font-bold text-xs transition-all duration-200 gap-2">
    ...
    <script>
        function handleRegisterSubmit(e) {
            ...
            Swal.fire({
                ...
                text: 'Sedang mendaftarkan akun Anda, mohon tunggu.',
